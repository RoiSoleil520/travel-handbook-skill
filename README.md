...
示例为“云南五日慢游”：大理 2 天（古城、洱海西岸与喜洲）＋丽江 3 天（大研、玉龙雪山/蓝月谷、白沙与返程），含天气备选与高德地图入口。景点背景采用公开文旅资料，来源链接在页面“行程总览”；已核实的公开票价写入行程与“费用预算”，并附查询日期和官方价目表；2027 年 4 月 3—7 日为演示日期，时间是建议安排，交通、住宿和门票均未预订，图片为示意。待办和偏好保存在当前浏览器，不需要服务器或登录。
