...
示例为“云南五日慢游”：大理 2 天（古城、洱海西岸与喜洲）＋丽江 3 天（大研、玉龙雪山/蓝月谷、白沙与返程），含天气备选与高德地图入口。首日展示小禾乘飞机、云舟与阿宁乘高铁、林夕取车自驾，在古城会合；人物、班次、航站楼、座位、交通时刻与费用均为假数据。“查看身份”可筛选各组安排，“交通住宿”汇总飞机与高铁，“交通接送”汇总自驾。

景点背景采用公开文旅资料，来源链接在页面“行程总览”；已核实的景点公开票价写入行程与“费用预算”，并附查询日期和官方价目表，与虚构交通价格明确区分。2027 年 4 月 3—7 日为演示日期，交通、住宿和门票均未预订，图片为示意。待办和偏好保存在当前浏览器，不需要服务器或登录。

地图按地点选择：中国内地地点使用高德，国外地点使用 Google Maps；飞机与铁路的出发、到达端分别处理。国内接送与自驾提供“起点地图”和“终点地图”搜索入口，国外保留 Google 路线入口。无需地图 SDK 或 API Key。
...
同行人也可以分别乘飞机、高铁或自驾抵达。提供各自班次或车辆、乘坐人员和已确认时间即可；铁路支持席别、车厢、每人座位与检票口，自驾支持预计用时及可选取车安排。缺失信息不强行填满，具体用法见 [Skill 使用说明](travel-handbook/README.md#同行人分别抵达)。

三种交通统一使用深色卡片。飞机和高铁提供计划起飞/发车倒计时，高铁发车后显示计划已发车或计划已抵达，均非实时运行状态；自驾显示预计用时，不增加倒计时。
